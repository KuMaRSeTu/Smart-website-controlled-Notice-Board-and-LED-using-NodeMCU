...
<html>
  ...
  <body>
      <p> <font size="9" face="sans-serif"> <center><h1>Smart Notice Board</h1> </center> </font> </p>
    ...
    <form action="updateDBLED.php" method="post" id="LED_OFF">
      <input type="hidden" name="Stat" value="0"/>
        ...
        <form action="updLCD.php" method="POST">
    Enter Text to Display: <input type="text" name="notice">
